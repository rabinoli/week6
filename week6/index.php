...
<head>
    ...
    <!-- STEP 1b: Add meta tag for author -->
    <meta name="author" content="Your Name" />
    <!-- STEP 1c: Add meta tag for description -->
...
<body id="section1">
<header>
    <img src="images/html-logo.svg" height="25" width="25" alt="HTML" />
    <nav>
        <ul>
            ...
            <!-- STEP 6: Add a link to index.php for consistency -->
...
<h2>Building Blocks for Web Developers</h2>
    ...
    <aside>
        ...
        <figure>
            ...
            <!-- STEP 1a: Add anchor element around 'LEGO®' -->
